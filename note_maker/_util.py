...
def i_vi_iii_v(root):
    return [[root], [root+vi], [root+iii], [root+v]]

def i_vi_iv_v(root):
    return [[root], [root+vi], [root+iv], [root+v]]

def i_v_vi_iv(root):
    return[[root], [root+v], [root+vi], [root+iv]]

def i_v_vi_iii_iv_i_iv_v(root):
    return[[root], [root+v], [root+vi], [root+iii], [root+iv], [root], [root+iv], [root+v]]

def vi_iii_iv_i_vi_ii_iv_v(root):
    return[[root+vi], [root+iii], [root+iv], [root], [root+vi], [root+ii], [root+iv], [root+v]]

def vi_ii_vi_ii_iv_i_iv_v(root):
    return [[root + vi], [root + ii], [root + vi], [root+ii], [root + iv], [root], [root + iv], [root + v]]
